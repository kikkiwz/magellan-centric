...
*** Test Cases ***
################### Post ###################
ImportThingBySupplier_TST_F30_0_4_008_Error_IMEILessThan15
	...
	#set IMEI1 (20 digit)
	${IMEI1}=    generate random string    21    [NUMBERS]
	...
	#Body
    ${body}=    Evaluate    [{"ConnectivityType":"${ConnectivityType1}","ThingName":"${ThingName1}","ThingIdentifier":"${ThingIdentifier1}","ThingSecret":"${ThingSecret1}","IMEI":"${IMEI1}"}]
	...
	#check response
    ${res_exepect}=    Set Variable    [{'ConnectivityType': '${ConnectivityType1}', 'ThingName': '${ThingName1}', 'ThingIdentifier': '${ThingIdentifier1}', 'ThingSecret': '${ThingSecret1}', 'IMEI': '${IMEI1}', 'CustomDetails': '{}', 'SupplierDetail': {}, 'Status': '${VALUE_LOG_CODE_40000}', 'StatusDescription': 'The length of IMEI must be 20 characters or fewer 15 characters. You entered 21 characters.'}]
    ...
    ${bodyLog}=    Set Variable    [{"ConnectivityType":"${ConnectivityType1}","ThingName":"${ThingName1}","ThingIdentifier":"${ThingIdentifier1}","ThingSecret":"${ThingSecret1}","IMEI":"${IMEI1}"}]
    ${responseLog}=    Set Variable    [{"ConnectivityType":"${ConnectivityType1}","ThingName":"${ThingName1}","ThingIdentifier":"${ThingIdentifier1},"ThingSecret":"${ThingSecret1}","IMEI":"${IMEI1}","CustomDetails":"{}","SupplierDetail":{"SupplierId":"${SupplierId}","SupplierName":null},"Status":"${VALUE_LOG_CODE_40000}","StatusDescription":"${VALUE_DESCRIPTION_THECLIENTREQUESTEDMISSINGORINVALIDFORMAT_ERROR}"}]		
