...
*** Test Cases ***
################### Post ###################
ImportThingBySupplier_TST_F30_0_4_002_Error_ThingNameOverMax50
	...
	#check response
    ${res_exepect}=    Set Variable    [{'ConnectivityType': '${ConnectivityType1}', 'ThingName': '${ThingName}', 'ThingIdentifier': '${ThingIdentifier1}', 'ThingSecret': '${ThingSecret1}', 'IMEI': '', 'CustomDetails': '{}', 'SupplierDetail': {}, 'Status': '${VALUE_LOG_CODE_40000}', 'StatusDescription': 'ThingName must be between 1 and 50 characters. You entered 60 characters.'}]
    ...
    ${responseLog}=    Set Variable    [{"ConnectivityType":"${ConnectivityType1}","ThingName":"${ThingName}","ThingIdentifier":"${ThingIdentifier1},"ThingSecret":"${ThingSecret1}","IMEI":"","CustomDetails":"{}","SupplierDetail":{"SupplierId":"${SupplierId}","SupplierName":null},"Status":"${VALUE_LOG_CODE_40000}","StatusDescription":"${VALUE_DESCRIPTION_THECLIENTREQUESTEDMISSINGORINVALIDFORMAT_ERROR}"}]		
