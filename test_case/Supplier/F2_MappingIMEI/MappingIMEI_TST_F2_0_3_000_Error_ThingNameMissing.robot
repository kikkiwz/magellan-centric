...
MappingIMEI_TST_F2_0_3_000_Error_ThingNameMissing.robot
	...
	#Body
    ${body}=    Evaluate    [{"ConnectivityType": "${ConnectivityType_import}","ThingIdentifier": "${ThingIdentifier_import}","ThingSecret": "${ThingSecret}","IMEI": "${IMEI}"}]
	...
	${bodyLog}=    Set Variable    [{"ConnectivityType":"${ConnectivityType_import}","ThingIdentifier":"${ThingIdentifier_import}","ThingSecret":"${ThingSecret}","IMEI":"${IMEI}"}]		
	${responseLog}=    Set Variable    [{"ConnectivityType":"${ConnectivityType_import}","ThingName":null,"ThingIdentifier":"${ThingIdentifier_import}","ThingSecret":"${ThingSecret}","IMEI":"${IMEI}","CustomDetails":null,"SupplierDetail":null,"Status":"${VALUE_LOG_CODE_40000}","StatusDescription":"${VALUE_DESCRIPTION_THINGNAMEISREQUIRED_ERROR}"}]		
