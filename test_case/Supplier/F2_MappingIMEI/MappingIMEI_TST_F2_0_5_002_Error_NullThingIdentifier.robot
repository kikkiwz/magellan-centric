...
*** Test Cases ***
################### Post ###################
MappingIMEI_TST_F2_0_5_002_Error_NullThingIdentifier
	...
	#Body
    ${body}=    Evaluate    [{"ConnectivityType": "${ConnectivityType_import}","ThingName": "${ThingName_import}", "ThingIdentifier": "","ThingSecret": "${ThingSecret}","IMEI": "${IMEI}"}]
	...
	${bodyLog}=    Set Variable    [{"ConnectivityType":"${ConnectivityType_import}","ThingName":"${ThingName_import}","ThingIdentifier":"","ThingSecret":"${ThingSecret}","IMEI":"${IMEI}"}]		
	${responseLog}=    Set Variable    [{"ConnectivityType":"${ConnectivityType_import}","ThingName":"${ThingName_import}","ThingIdentifier":"","ThingSecret":"${ThingSecret}","IMEI":"${IMEI}","CustomDetails":null,"SupplierDetail":null,"Status":"${VALUE_LOG_CODE_40000}","StatusDescription":"${VALUE_DESCRIPTION_THINGIDENTIFIERISREQUIRED_ERROR}"}]		
