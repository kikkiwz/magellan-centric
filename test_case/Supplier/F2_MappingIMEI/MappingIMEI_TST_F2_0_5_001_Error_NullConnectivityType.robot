...
*** Test Cases ***
################### Post ###################
MappingIMEI_TST_F2_0_5_001_Error_NullConnectivityType
	...
	#Body
    ${body}=    Evaluate    [{"ConnectivityType": "","ThingName": "${ThingName_import}","ThingIdentifier": "${ThingIdentifier_import}","ThingSecret": "${ThingSecret}","IMEI": "${IMEI}"}]
	...
	${bodyLog}=    Set Variable    [{"ConnectivityType":"","ThingName":"${ThingName_import}","ThingIdentifier":"${ThingIdentifier_import}","ThingSecret":"${ThingSecret}","IMEI":"${IMEI}"}]		
	${responseLog}=    Set Variable    [{"ConnectivityType":null,"ThingName":"${ThingName_import}","ThingIdentifier":"${ThingIdentifier_import}","ThingSecret":"${ThingSecret}","IMEI":"${IMEI}","CustomDetails":null,"SupplierDetail":null,"Status":"${VALUE_LOG_CODE_40000}","StatusDescription":"${VALUE_DESCRIPTION_CONNECTIVITYTYPEISREQUIRED_ERROR}"}]		
