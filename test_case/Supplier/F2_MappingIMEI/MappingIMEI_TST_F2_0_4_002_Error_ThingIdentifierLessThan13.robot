...
*** Test Cases ***
################### Post ###################
MappingIMEI_TST_F2_0_4_002_Error_ThingIdentifierLessThan13
	...
	${expectResponse}=    Evaluate   [{'Status': '${VALUE_LOG_CODE_40000}','StatusDescription': 'The length of ThingIdentifier must be 13 characters or fewer. You entered ${length} characters.'}]
	...
	${responseLog}=    Set Variable    [{"ConnectivityType":"${ConnectivityType_import}","ThingName":"${ThingName_import}","ThingIdentifier":"${ThingIdentifier}","ThingSecret":"${ThingSecret_import}","IMEI":"${IMEI}","CustomDetails":null,"SupplierDetail":null,"Status":"${VALUE_LOG_CODE_40000}","StatusDescription":"The length of ThingIdentifier must be 13 characters or fewer. You entered ${length} characters."}]		
