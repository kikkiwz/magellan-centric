...
*** Test Cases ***
################### Post ###################
MappingIMEI_TST_F2_0_4_006_Error_ThingSecretOverMax20
	...
	#Body
    ${body}=    Evaluate    [{"ConnectivityType": "${ConnectivityType_import}","ThingName": "${ThingName_import}","ThingIdentifier": "${ThingIdentifier_import}","ThingSecret": "${ThingSecret}","IMEI": "${IMEI}"}]
	...
	${expectResponse}=    Evaluate   [{'Status': '${VALUE_LOG_CODE_40000}','StatusDescription': 'The length of ThingSecret must be 20 characters. You entered ${length} characters.'}]
	...
	${bodyLog}=    Set Variable    [{"ConnectivityType":"${ConnectivityType_import}","ThingName":"${ThingName_import}","ThingIdentifier":"${ThingIdentifier_import}","ThingSecret":"${ThingSecret}","IMEI":"${IMEI}"}]		
	${responseLog}=    Set Variable    [{"ConnectivityType":"${ConnectivityType_import}","ThingName":"${ThingName_import}","ThingIdentifier":"${ThingIdentifier_import}","ThingSecret":"${ThingSecret}","IMEI":"${IMEI}","CustomDetails":null,"SupplierDetail":null,"Status":"${VALUE_LOG_CODE_40000}","StatusDescription":"The length of ThingSecret must be 20 characters. You entered ${length} characters."}]		
