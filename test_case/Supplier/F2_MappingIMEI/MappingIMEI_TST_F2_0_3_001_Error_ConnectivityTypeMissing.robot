...
*** Test Cases ***
################### Post ###################
MappingIMEI_TST_F2_0_3_001_Error_ConnectivityTypeMissing
	...
	#Body
    ${body}=    Evaluate    [{"ThingName": "${ThingName_import}","ThingIdentifier": "${ThingIdentifier_import}","ThingSecret": "${ThingSecret}","IMEI": "${IMEI}"}]
	...
	${bodyLog}=    Set Variable    [{"ThingName":"${ThingName_import}","ThingIdentifier":"${ThingIdentifier_import}","ThingSecret":"${ThingSecret}","IMEI":"${IMEI}"}]		
