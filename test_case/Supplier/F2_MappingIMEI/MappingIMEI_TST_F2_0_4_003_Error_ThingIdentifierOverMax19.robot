...
*** Test Cases ***
################### Post ###################
MappingIMEI_TST_F2_0_4_003_Error_ThingIdentifierOverMax19
	...
	${expectResponse}=    Evaluate   [{'Status': '${VALUE_LOG_CODE_40000}','StatusDescription': 'The length of ThingIdentifier must be 19 characters or fewer. You entered ${length} characters.'}]
