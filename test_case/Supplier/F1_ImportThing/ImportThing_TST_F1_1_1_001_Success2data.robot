...
*** Test Cases ***
################### Post ###################
ImportThing_TST_F1_1_1_001_Success2data
	...
	${ThingIdentifier1}=    Set Variable    ${randomICCID1}${randomICCID2}
	...
	${ThingIdentifier1Response}=    Set Variable    ${FIELD_ICCIDPRE}${ThingIdentifier1}
    ...
    #Headers
	${headers}=    Create Dictionary        Content-Type=${HEADER_CONTENT_TYPE}    x-ais-UserName=${HEADER_X_AIS_USERNAME_AISPARTNER}    x-ais-OrderRef=${HEADER_X_AIS_ORDERREF_IMPORTTHING}${current_timestamp}    x-ais-OrderDesc=${HEADER_X_AIS_ORDERDESC_IMPORTTHING}    Accept=${HEADER_ACCEPT}  
	Log To Console    Headers is : ${headers}

	#Body
    ${body}=    Evaluate    [{"ConnectivityType":"${ConnectivityType1}","ThingName":"${ThingName1}","ThingIdentifier":"${ThingIdentifier1}","ThingSecret":"${ThingSecret1}"},{"ConnectivityType":"${ConnectivityType2}","ThingName":"${ThingName2}","ThingIdentifier":"${ThingIdentifier2}","ThingSecret":"${ThingSecret2}"}]
    ...
    ${expectResponse}=    Evaluate    [{"Status":"${VALUE_LOG_CODE_20100}","StatusDescription":"${VALUE_DESCRIPTION_IMPORTTHING_SUCCESS}"},{"Status":"${VALUE_LOG_CODE_20100}","StatusDescription":"${VALUE_DESCRIPTION_IMPORTTHING_SUCCESS}"}]		
	...
	${dataSearch}=    Set Variable    ${HEADER_X_AIS_ORDERREF_IMPORTTHING}${current_timestamp}
    ...
    ${bodyLog}=    Set Variable    [{"ConnectivityType":"${ConnectivityType1}","ThingName":"${ThingName1}","ThingIdentifier":"${ThingIdentifier1}","ThingSecret":"${ThingSecret1}"},{"ConnectivityType":"${ConnectivityType2}","ThingName":"${ThingName2}","ThingIdentifier":"${ThingIdentifier2}","ThingSecret":"${ThingSecret2}"}]		
    ${responseLog}=    Set Variable    [{"ConnectivityType":"${ConnectivityType1}","ThingName":"${ThingName1}","ThingIdentifier":"${ThingIdentifier1Response}","ThingSecret":"${ThingSecret1}","IMEI":"","CustomDetails":"{}","SupplierDetail":{"SupplierId":null,"SupplierName":null},"Status":"${VALUE_LOG_CODE_20100}","StatusDescription":"${VALUE_DESCRIPTION_IMPORTTHING_SUCCESS}"},{"ConnectivityType":"${ConnectivityType2}","ThingName":"${ThingName2}","ThingIdentifier":"${ThingIdentifier2Response}","ThingSecret":"${ThingSecret2}","IMEI":"","CustomDetails":"{}","SupplierDetail":{"SupplierId":null,"SupplierName":null},"Status":"${VALUE_LOG_CODE_20100}","StatusDescription":"${VALUE_DESCRIPTION_IMPORTTHING_SUCCESS}"}]		

	${bodyDB}=    Evaluate    [{"ConnectivityType":"${ConnectivityType1}","ThingName":"${ThingName1}","ThingIdentifier":"${ThingIdentifier1Response}","ThingSecret":"${ThingSecret1}","IMEI":"${IMEI1}","CustomDetails":"{}","SupplierDetail":{"SupplierId":"${SupplierId1}","SupplierName":"${SupplierName1}"}},{"ConnectivityType":"${ConnectivityType2}","ThingName":"${ThingName2}","ThingIdentifier":"${ThingIdentifier2Response}","ThingSecret":"${ThingSecret2}","IMEI":"${IMEI2}","CustomDetails":"{}","SupplierDetail":{"SupplierId":"${SupplierId2}","SupplierName":"${SupplierName2}"}}]		
	...
	FOR    ${i}    IN RANGE    ${count}
        Run Keyword If    '${checkReponse}'=='true'    Request Verify DB Check Data ImportThing    ${bodyDB}[${i}]    ${ThingName${i+1}}
    END        

   
	#Get Id For Delete
	${ThingNameArr}=    Evaluate    ["${ThingName1}","${ThingName2}"]
