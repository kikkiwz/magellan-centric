...
*** Test Cases ***
################### Post ###################
ImportThing_TST_F1_0_3_001_Error_MissingConnectivityType
	...
	#Body
    ${body}=    Evaluate    [{"ThingName":"${ThingName1}","ThingIdentifier":"${ThingIdentifier1}","ThingSecret":"${ThingSecret1}"}]
    ...
    ${expectResponse}=    Evaluate    [{"Status":"${VALUE_LOG_CODE_40000}","StatusDescription":"${VALUE_DESCRIPTION_CONNECTIVITYTYPEISREQUIRED_ERROR}"}]		
    ...
    ${bodyLog}=    Set Variable    [{"ThingName":"${ThingName1}","ThingIdentifier":"${ThingIdentifier1}","ThingSecret":"${ThingSecret1}"}]		
    ${responseLog}=    Set Variable    [{"ConnectivityType":null,"ThingName":"${ThingName1}","ThingIdentifier":"${ThingIdentifier1}","ThingSecret":"${ThingSecret1}","IMEI":"","CustomDetails":"{}","SupplierDetail":{"SupplierId":null,"SupplierName":null},"Status":"${VALUE_LOG_CODE_40000}","StatusDescription":"${VALUE_DESCRIPTION_CONNECTIVITYTYPEISREQUIRED_ERROR}"}]		
