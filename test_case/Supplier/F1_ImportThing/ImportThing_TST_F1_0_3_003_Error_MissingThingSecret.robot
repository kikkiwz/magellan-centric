...
*** Test Cases ***
################### Post ###################
ImportThing_TST_F1_0_3_003_Error_MissingThingSecret
	...
	#Body
    ${body}=    Evaluate    [{"ConnectivityType":"${ConnectivityType1}","ThingIdentifier":"${ThingIdentifier1}","ThingName":"${ThingName1}"}]
    ...
    ${bodyLog}=    Set Variable    [{"ConnectivityType":"${ConnectivityType1}","ThingIdentifier":"${ThingIdentifier1}","ThingName":"${ThingName1}"}]		
    ${responseLog}=    Set Variable    [{"ConnectivityType":"${ConnectivityType1}","ThingName":"${ThingName1}","ThingIdentifier":"${ThingIdentifier1}","ThingSecret":null,"IMEI":"","CustomDetails":"{}","SupplierDetail":{"SupplierId":null,"SupplierName":null},"Status":"${VALUE_LOG_CODE_40000}","StatusDescription":"${VALUE_DESCRIPTION_THINGSECRETISREQUIRED_ERROR}"}]		
