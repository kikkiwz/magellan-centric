...
*** Test Cases ***
################### Post ###################
ImportThing_TST_F1_0_4_002_Error_ThingIdentifierLessThan13
	...
	${randomICCID1}=    Evaluate    random.randint(100000, 999999)    random
    ...
    ${responseLog}=    Set Variable    [{"ConnectivityType":"${ConnectivityType1}","ThingName":"${ThingName1}","ThingIdentifier":"${ThingIdentifier1}","ThingSecret":"${ThingSecret1}","IMEI":"","CustomDetails":"{}","SupplierDetail":{"SupplierId":null,"SupplierName":null},"Status":"${VALUE_LOG_CODE_40000}","StatusDescription":"${VALUE_DESCRIPTION_THINGIDENTIFIERLESSTHAN13_ERROR}"}]		
