...
*** Test Cases ***
################### Post ###################
ImportThing_TST_F1_0_4_000_Error_ThingNameOveMax50
    ...
    #-------- Prepare data 1 --------
	#ThingName1
    ${random_number1}=    generate random string    15    [NUMBERS]
    ${ThingName1}=    Set Variable    ${VALUE_ATHINGNAME}${random_number1}${random_number1}${random_number1}
    ...
    ${expectResponse}=    Evaluate    [{"Status":"${VALUE_LOG_CODE_40000}","StatusDescription":"${VALUE_DESCRIPTION_THINGNAMEOVERMAX50_ERROR}"}]		
    ...
    ${responseLog}=    Set Variable    [{"ConnectivityType":"${ConnectivityType1}","ThingName":"${ThingName1}","ThingIdentifier":"${ThingIdentifier1}","ThingSecret":"${ThingSecret1}","IMEI":"","CustomDetails":"{}","SupplierDetail":{"SupplierId":null,"SupplierName":null},"Status":"${VALUE_LOG_CODE_40000}","StatusDescription":"${VALUE_DESCRIPTION_THINGNAMEOVERMAX50_ERROR}"}]		
