...
*** Test Cases ***
################### Post ###################
ImportThing_TST_F1_0_4_006_Error_ThingIdentifier_14Digit
	...
	${randomICCID1}=    Evaluate    random.randint(10000000, 99999999)    random
	${randomICCID2}=    Evaluate    random.randint(1000000, 9999999)    random
    ${randomICCID3}=    Evaluate    random.randint(100000, 999999)    random
	${ThingIdentifier1}=    Set Variable    ${FIELD_ICCIDPRE}${randomICCID1}
    ...
    ${expectResponse}=    Evaluate    [{"Status":"${VALUE_LOG_CODE_40000}","StatusDescription":"${VALUE_DESCRIPTION_THINGIDENTIFIER14DIGIT_ERROR}"}]		
    ...
    ${responseLog}=    Set Variable    [{"ConnectivityType":"${ConnectivityType1}","ThingName":"${ThingName1}","ThingIdentifier":"${ThingIdentifier1}","ThingSecret":"${ThingSecret1}","IMEI":"","CustomDetails":"{}","SupplierDetail":{"SupplierId":null,"SupplierName":null},"Status":"${VALUE_LOG_CODE_40000}","StatusDescription":"${VALUE_DESCRIPTION_THINGIDENTIFIER14DIGIT_ERROR}"}]		
