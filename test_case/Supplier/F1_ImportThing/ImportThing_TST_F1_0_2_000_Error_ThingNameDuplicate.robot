...
*** Test Cases ***
################### Post ###################
ImportThing_TST_F1_0_2_000_Error_ThingNameDuplicate
	...
	#Body
    ${body2}=    Evaluate    [{"ConnectivityType":"${ConnectivityType2}","ThingName":"${ThingName1}","ThingIdentifier":"${ThingIdentifier2}","ThingSecret":"${ThingSecret2}"}]
    Log To Console    Body is : ${body}
    ...
    ${expectResponse}=    Evaluate    [{"Status":"${VALUE_LOG_CODE_40301}","StatusDescription":"${VALUE_DESCRIPTION_THETHINGNAMECOULDNOTBEDUPLICATED_ERROR}"}]		
    ...
    ${bodyLog}=    Set Variable    [{"ConnectivityType":"${ConnectivityType2}","ThingName":"${ThingName1}","ThingIdentifier":"${ThingIdentifier2}","ThingSecret":"${ThingSecret2}"}]		
    ${responseLog}=    Set Variable    [{"ConnectivityType":"${ConnectivityType2}","ThingName":"${ThingName1}","ThingIdentifier":"896603${ThingIdentifier2}","ThingSecret":"${ThingSecret2}","IMEI":"","CustomDetails":"{}","SupplierDetail":{"SupplierId":null,"SupplierName":null},"Status":"${VALUE_LOG_CODE_40301}","StatusDescription":"${VALUE_DESCRIPTION_THETHINGNAMECOULDNOTBEDUPLICATED_ERROR}"}]		
