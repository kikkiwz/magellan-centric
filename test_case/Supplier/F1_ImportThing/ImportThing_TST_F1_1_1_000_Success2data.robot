...
*** Test Cases ***
################### Post ###################
ImportThing_TST_F1_1_1_000_Success2data
    ...
    ${responseLog}=    Set Variable    [{"ConnectivityType":"${ConnectivityType1}","ThingName":"${ThingName1}","ThingIdentifier":"${ThingIdentifier1}","ThingSecret":"${ThingSecret1}","IMEI":"","CustomDetails":"{}","SupplierDetail":{"SupplierId":null,"SupplierName":null},"Status":"${VALUE_LOG_CODE_20100}","StatusDescription":"${VALUE_DESCRIPTION_IMPORTTHING_SUCCESS}"},{"ConnectivityType":"${ConnectivityType2}","ThingName":"${ThingName2}","ThingIdentifier":"${ThingIdentifier2Response}","ThingSecret":"${ThingSecret2}","IMEI":"","CustomDetails":"{}","SupplierDetail":{"SupplierId":null,"SupplierName":null},"Status":"${VALUE_LOG_CODE_20100}","StatusDescription":"${VALUE_DESCRIPTION_IMPORTTHING_SUCCESS}"}]		

	${bodyDB}=    Evaluate    [{"ConnectivityType":"${ConnectivityType1}","ThingName":"${ThingName1}","ThingIdentifier":"${ThingIdentifier1}","ThingSecret":"${ThingSecret1}","IMEI":"${IMEI1}","CustomDetails":"{}","SupplierDetail":{"SupplierId":"${SupplierId1}","SupplierName":"${SupplierName1}"}},{"ConnectivityType":"${ConnectivityType2}","ThingName":"${ThingName2}","ThingIdentifier":"${ThingIdentifier2Response}","ThingSecret":"${ThingSecret2}","IMEI":"${IMEI2}","CustomDetails":"{}","SupplierDetail":{"SupplierId":"${SupplierId2}","SupplierName":"${SupplierName2}"}}]		
