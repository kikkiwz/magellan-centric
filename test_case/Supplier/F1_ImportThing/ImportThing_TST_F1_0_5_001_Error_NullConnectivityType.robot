...
*** Test Cases ***
################### Post ###################
ImportThing_TST_F1_0_5_001_Error_NullConnectivityType
	...
	#Body
    ${body}=    Evaluate    [{"ConnectivityType":"","ThingName":"${ThingName1}","ThingIdentifier":"${ThingIdentifier1}","ThingSecret":"${ThingSecret1}"}]
    ...
    ${bodyLog}=    Set Variable    [{"ConnectivityType":"","ThingName":"${ThingName1}","ThingIdentifier":"${ThingIdentifier1}","ThingSecret":"${ThingSecret1}"}]		
