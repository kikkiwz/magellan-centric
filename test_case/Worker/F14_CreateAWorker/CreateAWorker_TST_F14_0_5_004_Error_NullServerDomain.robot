...
*** Test Cases ***
################### Post ###################
CreateAWorker_TST_F14_0_5_004_Error_NullServerDomain
	...
	#Body
    ${body}=    Evaluate    {"WorkerName":"${WorkerName}","ServerProperties":{"ServerIP":"${ServerIP}","ServerPort":"${ServerPort}","ServerDomain":""},"WorkerState":"${WorkerState}"}
	...
	${bodyLog}=    Set Variable    {"WorkerName":"${WorkerName}","ServerProperties":{"ServerIP":"${ServerIP}","ServerPort":"${ServerPort}","ServerDomain":""},"WorkerState":"${WorkerState}"}
