...
*** Test Cases ***
################### Post ###################
CreateAWorker_TST_F14_0_3_003_Error_MissingServerPort
	...
	#Body
    ${body}=    Evaluate    {"WorkerName":"${WorkerName}","ServerProperties":{"ServerIP":"${ServerIP}","ServerDomain":"${ServerDomain}"},"WorkerState":"${WorkerState}"}
	...
	${bodyLog}=    Set Variable    {"WorkerName":"${WorkerName}","ServerProperties":{"ServerIP":"${ServerIP}","ServerDomain":"${ServerDomain}"},"WorkerState":"${WorkerState}"}
