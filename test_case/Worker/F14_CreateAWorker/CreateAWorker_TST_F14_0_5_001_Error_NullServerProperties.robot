...
*** Test Cases ***
################### Post ###################
CreateAWorker_TST_F14_0_5_001_Error_NullServerProperties
	...
	#Body
    ${body}=    Evaluate    {"WorkerName":"${WorkerName}","ServerProperties":"","WorkerState":"${WorkerState}"}
	...
	${bodyLog}=    Set Variable    {"WorkerName":"${WorkerName}","ServerProperties":"","WorkerState":"${WorkerState}"}
