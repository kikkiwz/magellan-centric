...
*** Test Cases ***
################### Post ###################
CreateAWorker_TST_F14_0_2_001_Error_WorkerStateIdle
	...
	${WorkerState}=    Set Variable    ${VALUE_WORKERSTATE_IDLE}
    ...
    ${responseObjectDetail}=    Set Variable    [{"Target":"WorkerState","DeveloperMessage":"Error converting value \\"Idle\\" to type \'System.Nullable`1[Centric_MongoDBService.Enum.Worker.WorkerState]\'. Path \'WorkerState\', line 1, position 154."}]
