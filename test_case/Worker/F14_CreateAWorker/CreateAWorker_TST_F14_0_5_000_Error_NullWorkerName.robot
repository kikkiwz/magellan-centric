...
*** Test Cases ***
################### Post ###################
CreateAWorker_TST_F14_0_5_000_Error_NullWorkerName
	...
	#Body
    ${body}=    Evaluate    {"WorkerName":"","ServerProperties":{"ServerIP":"${ServerIP}","ServerPort":"${ServerPort}","ServerDomain":"${ServerDomain}"},"WorkerState":"${WorkerState}"}
	...
	${bodyLog}=    Set Variable    {"WorkerName":"","ServerProperties":{"ServerIP":"${ServerIP}","ServerPort":"${ServerPort}","ServerDomain":"${ServerDomain}"},"WorkerState":"${WorkerState}"}
