...
*** Test Cases ***
################### Post ###################
CreateAWorker_TST_F14_0_3_001_Error_MissingServerProperties
	...
	#Body
    ${body}=    Evaluate    {"WorkerName":"${WorkerName}","WorkerState":"${WorkerState}"}
	...
	${bodyLog}=    Set Variable    {"WorkerName":"${WorkerName}","WorkerState":"${WorkerState}"}
