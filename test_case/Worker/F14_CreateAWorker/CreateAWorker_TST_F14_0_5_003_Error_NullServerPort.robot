...
*** Test Cases ***
################### Post ###################
CreateAWorker_TST_F14_0_5_003_Error_NullServerPort
	...
	#Body
    ${body}=    Evaluate    {"WorkerName":"${WorkerName}","ServerProperties":{"ServerIP":"${ServerIP}","ServerPort":"","ServerDomain":"${ServerDomain}"},"WorkerState":"${WorkerState}"}
	...
	${bodyLog}=    Set Variable    {"WorkerName":"${WorkerName}","ServerProperties":{"ServerIP":"${ServerIP}","ServerPort":"","ServerDomain":"${ServerDomain}"},"WorkerState":"${WorkerState}"}
