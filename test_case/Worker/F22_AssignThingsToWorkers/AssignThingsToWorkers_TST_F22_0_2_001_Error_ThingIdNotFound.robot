...
*** Test Cases ***
################### Post ###################
AssignThingsToWorkers_TST_F22_0_2_001_Error_ThingIdNotFound
	...
	#DeleteAThing
    ${postDeleteAThing}=    Delete A Thing    ${URL_CENTRIC}    ${ThingId}
	Log To Console    postDeleteAThing: :${postDeleteAThing} 
    ...
    ${responseLog}=    Set Variable    [{"ThingId":"${ThingId}","WorkerId":"${WorkerId}","Status":"${VALUE_LOG_CODE_40400}","StatusDescription":"${VALUE_DESCRIPTION_THINGCOULDNOTFOUND_ERROR}"}]		
