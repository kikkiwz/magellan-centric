...
*** Test Cases ***
################### Delete ###################
DeleteThingsFromWorker_TST_F24_0_3_000_Error_MissingWorkerId 
	...
	#urlDeleteThingsFromWorkerLog
	${urlDeleteThingsFromWorkerLog}=    Replace String    ${URL_DELETETHINGSFROMWORKER}    /WorkerId    ${EMPTY}
    Log To Console    urlDeleteThingsFromWorkerLog is : ${urlDeleteThingsFromWorkerLog}

	#urlDeleteThingsFromWorker
	${urlDeleteThingsFromWorker}=    Replace String    ${URL_DELETETHINGSFROMWORKER}    WorkerId    ${EMPTY}
    ...
    ${pathUrl}=    Set Variable    ${urlDeleteThingsFromWorkerLog}
