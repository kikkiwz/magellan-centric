...
*** Test Cases ***
################### Put ###################
UpdateThingsToWorkers_TST_F23_0_3_000_Error_MissingWorkerId 
	...
	#urlUpdateThingsToWorkersLog
	${urlUpdateThingsToWorkersLog}=    Replace String    ${URL_UPDATETHINGSTOWORKERS}    /WorkerId    ${EMPTY}
    Log To Console    urlUpdateThingsToWorkersLog is : ${urlUpdateThingsToWorkersLog}

	#urlUpdateThingsToWorkers
	${urlUpdateThingsToWorkers}=    Replace String    ${URL_UPDATETHINGSTOWORKERS}    WorkerId    ${EMPTY}
    ...
    ${pathUrl}=    Set Variable    ${urlUpdateThingsToWorkersLog}
