...
*** Test Cases ***
################### Put ###################
UpdateThingsToWorkers_TST_F23_0_4_000_Error_WorkerIdTest
	...
	${urlUpdateThingsToWorkers}=    Replace String    ${URL_UPDATETHINGSTOWORKERS}    WorkerId    ${VALUE_CENTRIC_UPDATETHINGSTOWORKERS_WORKERID_INVALID}
    ...
    ${checkReponse}=    Run keyword And Continue On Failure    Response ResultCode Should Have Error    ${res}    ${UPDATETHINGSTOWORKERS}   ${FIELD_OPERATIONSTATUS}    ${FIELD_CODE}    ${FIELD_DEVELOPERMESSAGE}    ${VALUE_LOG_CODE_40000}    ${VALUE_DESCRIPTION_THECLIENTREQUESTEDMISSINGORINVALIDFORMAT_ERROR}
    ...
    Log UpdateThingsToWorkers Error    ${VALUE_LOG_CODE_40000}    ${VALUE_DESCRIPTION_THECLIENTREQUESTEDMISSINGORINVALIDFORMAT_ERROR}    ${VALUE_LOG_CODE_40000}    ${VALUE_DESCRIPTION_THECLIENTREQUESTEDMISSINGORINVALIDFORMAT_ERROR}    ${res}    ${pathUrl}    ${dataSearch}    ${endPointName}    ${custom}    ${customDetailDB}    ${responseObjectDetail}    ${bodyLog}    ${cmdName}
