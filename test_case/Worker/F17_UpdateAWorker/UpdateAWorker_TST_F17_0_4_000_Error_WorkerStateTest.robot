...
*** Test Cases ***
################### Put ###################
UpdateAWorker_TST_F17_0_4_000_Error_WorkerStateTest
	...
	${WorkerState}=    Set Variable    ${VALUE_WORKERSTATE_TEST}
    ...
    ${responseObjectDetail}=    Set Variable    [{"Target":"WorkerState","DeveloperMessage":"Error converting value \\"Test\\" to type 'System.Nullable`1[Centric_MongoDBService.Enum.Worker.WorkerState]'. Path 'WorkerState', line 1, position 201."}]
