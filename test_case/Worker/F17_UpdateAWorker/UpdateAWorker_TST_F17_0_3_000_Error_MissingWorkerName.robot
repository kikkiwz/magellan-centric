...
*** Test Cases ***
################### Put ###################
UpdateAWorker_TST_F17_0_3_000_Error_MissingWorkerName
	...
	#Body
    ${body}=    Evaluate    {"WorkerId":"${WorkerId}","ServerProperties":{"ServerIP":"${ServerIP}","ServerPort":"${ServerPort}","ServerDomain":"${ServerDomain}"},"WorkerState":"${WorkerState}"}
	...
	${bodyLog}=    Set Variable    {"WorkerId":"${WorkerId}","ServerProperties":{"ServerIP":"${ServerIP}","ServerPort":"${ServerPort}","ServerDomain":"${ServerDomain}"},"WorkerState":"${WorkerState}"}
