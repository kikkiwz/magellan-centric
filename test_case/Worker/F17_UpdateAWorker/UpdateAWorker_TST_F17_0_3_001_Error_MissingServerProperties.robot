...
*** Test Cases ***
################### Put ###################
UpdateAWorker_TST_F17_0_3_001_Error_MissingServerProperties
	...
	#Body
    ${body}=    Evaluate    {"WorkerId":"${WorkerId}","WorkerName":"${WorkerNameUpdate}","WorkerState":"${WorkerState}"}
	...
	${bodyLog}=    Set Variable    {"WorkerId":"${WorkerId}","WorkerName":"${WorkerNameUpdate}","WorkerState":"${WorkerState}"}
