...
*** Test Cases ***
################### Put ###################
UpdateAWorker_TST_F17_0_5_004_Error_NullServerDomain
	...
	#Body
    ${body}=    Evaluate    {"WorkerId":"${WorkerId}","WorkerName":"${WorkerNameUpdate}","ServerProperties":{"ServerIP":"${ServerIP}","ServerPort":"${ServerPort}","ServerDomain":""},"WorkerState":"${WorkerState}"}
	...
	${bodyLog}=    Set Variable    {"WorkerId":"${WorkerId}","WorkerName":"${WorkerNameUpdate}","ServerProperties":{"ServerIP":"${ServerIP}","ServerPort":"${ServerPort}","ServerDomain":""},"WorkerState":"${WorkerState}"}
