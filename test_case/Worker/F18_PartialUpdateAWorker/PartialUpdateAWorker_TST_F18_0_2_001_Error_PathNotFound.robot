...
*** Test Cases ***
################### Patch ###################
PartialUpdateAWorker_TST_F18_0_2_001_Error_PathNotFound
	...
	${path}=    Set Variable    ${VALUE_CENTRIC_PARTIALUPDATE_PATH_SERVERPROPERTIES_SERVERDOMAIN_INVALID}
    ...
    ${responseObjectDetail}=    Set Variable    [{"Target":"WorkersUpdateDto","DeveloperMessage":"The target location specified by path segment \'ServerDomainx\' was not found."}]
