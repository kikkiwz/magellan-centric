...
*** Test Cases ***
################### Post ###################
PartialUpdateAThing_TST_F12_0_3_003_Error_op_add_Missingvalue
	...
	#Body
    ${body}=    Evaluate    [{"op": "add","path": "/SupplierDetail/SupplierId"},{"op": "add","path": "/SupplierDetail/SupplierName"}]
	...
	${bodyLog}=    Set Variable    [{"op":"add","path":"/SupplierDetail/SupplierId"},{"op":"add","path":"/SupplierDetail/SupplierName"}]
