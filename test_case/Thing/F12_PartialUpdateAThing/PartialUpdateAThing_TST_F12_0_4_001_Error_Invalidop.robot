...
*** Test Cases ***
################### Post ###################
PartialUpdateAThing_TST_F12_0_4_001_Error_Invalidop
	...
	#Body
    ${body}=    Evaluate    [{"op": "xxx","path": "/SupplierDetail/SupplierId","value": "${SupplierId_Update}"}]
    ...
    ${DeveloperMessage}=    Set Variable    Invalid JsonPatch operation 'xxx'.
	...
	${bodyLog}=    Set Variable    [{"op":"xxx","path":"/SupplierDetail/SupplierId","value":"${SupplierId_Update}"}]
