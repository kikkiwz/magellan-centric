...
*** Test Cases ***
################### Post ###################
PartialUpdateAThing_TST_F12_0_5_001_Error_Nullpath
	...
	#Body
    ${body}=    Evaluate    [{"op": "add","path": "","value": "${SupplierId_Update}"}]
    ...
    ${DeveloperMessage}=    Set Variable    The target location specified by path segment '' was not found.
	...
	${bodyLog}=    Set Variable    [{"op":"add","path":"","value":"${SupplierId_Update}"}]
