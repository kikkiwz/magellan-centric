...
*** Test Cases ***
################### Post ###################
PartialUpdateAThing_TST_F12_0_5_002_Error_NullvalueOpAdd
	...
	#Body
    ${body}=    Evaluate    [{"op": "add","path": "/SupplierDetail/SupplierId","value":""},{"op": "add","path": "/SupplierDetail/SupplierName","value":""}]
	...
	${bodyLog}=    Set Variable    [{"op":"add","path":"/SupplierDetail/SupplierId","value":""},{"op":"add","path":"/SupplierDetail/SupplierName","value":""}]
