...
*** Test Cases ***
################### Post ###################
UpdateAThing_TST_F11_0_4_005_Error_ThingIdentifierLessThan13
    ...
    ${DeveloperMessage}=    Set Variable    The length of '${Target}' must be at least 13 characters. You entered ${length} characters.
