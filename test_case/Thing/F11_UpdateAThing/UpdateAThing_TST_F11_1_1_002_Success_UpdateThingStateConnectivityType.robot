...
*** Test Cases ***
################### Post ###################
UpdateAThing_TST_F11_1_1_002_Success_UpdateThingStateConnectivityType
	...
	Run keyword And Continue On Failure    Should Be Equal As Strings    ${GetResponse_ConnectivityType}    ${VALUE_CONNECTIVITYTYPE_WIFI}
    ...
    Run Keyword If    '${checkReponse}'=='true'    Request Verify DB Check Things    ${ThingId}    None    ${ConnectivityType}    ${ThingName_Create}    ${FIELD_ICCIDPRE}${ThingIdentifier}    ${ThingSecret}    ${IMEI}    ${ThingState}    ${SupplierId_Create}    ${SupplierName_Create}    None    None
