...
*** Test Cases ***
################### Post ###################
UpdateAThing_TST_F11_0_4_004_Error_IMEILessThan15
    ...
    ${DeveloperMessage}=    Set Variable    The length of '${Target}' must be at least 15 characters. You entered ${length} characters.
