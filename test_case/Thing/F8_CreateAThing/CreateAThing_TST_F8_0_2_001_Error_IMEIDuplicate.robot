...
*** Test Cases ***
################### Post ###################
CreateAThing_TST_F8_0_2_001_Error_IMEIDuplicate
    ...
    #Create A Thing
	${postCreateAThing_1st}=    Create A Thing Not Have WorkerId   ${URL_CENTRIC}    ${ConnectivityType_1st}    ${ThingState_1st}    ${ThingIdentifier_1st}    ${ThingSecret_1st}    ${IMEI_1st}
    ...
    ${random_number_2nd}=    generate random string    6    [NUMBERS]
	...
	${ThingState_2nd}=    Set Variable    Pending
	...
	#Body
    ${body}=    Evaluate    {"ConnectivityType": "${ConnectivityType_2nd}","ThingName" : "${ThingName}","ThingIdentifier": "${ThingIdentifier_2nd}","ThingSecret": "${ThingSecret_2nd}","IMEI": "${IMEI_1st}","CustomDetails":{},"SupplierDetail": {"SupplierId": "${SupplierId}","SupplierName": "${SupplierName}"}}
	...
	${bodyLog}=    Set Variable    {"ConnectivityType":"${ConnectivityType_2nd}","ThingName":"${ThingName}","ThingIdentifier":"${ThingIdentifier_2nd}","ThingSecret":"${ThingSecret_2nd}","IMEI":"${IMEI_1st}","CustomDetails":{},"SupplierDetail":{"SupplierId":"${SupplierId}","SupplierName":"${SupplierName}"}}
