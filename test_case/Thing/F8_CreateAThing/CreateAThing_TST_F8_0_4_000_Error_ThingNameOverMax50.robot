...
*** Test Cases ***
################### Post ###################
CreateAThing_TST_F8_0_4_000_Error_ThingNameOverMax50
    ...
    ${length}=    Set Variable    60
    ${random_number}=    generate random string    6    [NUMBERS]
    ${random_number_thingName}=    generate random string    ${length}    [NUMBERS]
    ...
    ${DeveloperMessage}=    Set Variable    The length of '${Target}' must be 50 characters or fewer. You entered ${length} characters.
