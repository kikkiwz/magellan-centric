...
*** Test Cases ***
################### Post ###################
CreateAThing_TST_F8_0_2_003_Error_ThingIdentifierDuplicate
	...
	#Body
    ${body}=    Evaluate    {"ConnectivityType": "${ConnectivityType_2nd}","ThingName" : "${ThingName}","ThingIdentifier": "${ThingIdentifier_1st}","ThingSecret": "${ThingSecret_2nd}","IMEI": "${IMEI_2nd}","CustomDetails":{},"SupplierDetail": {"SupplierId": "${SupplierId}","SupplierName": "${SupplierName}"}}
    ...
    #GetResponse_Details
    ${Target}=    Set Variable    ThingIdentifier
	...
	${bodyLog}=    Set Variable    {"ConnectivityType":"${ConnectivityType_2nd}","ThingName":"${ThingName}","ThingIdentifier":"${ThingIdentifier_1st}","ThingSecret":"${ThingSecret_2nd}","IMEI":"${IMEI_2nd}","CustomDetails":{},"SupplierDetail":{"SupplierId":"${SupplierId}","SupplierName":"${SupplierName}"}}
