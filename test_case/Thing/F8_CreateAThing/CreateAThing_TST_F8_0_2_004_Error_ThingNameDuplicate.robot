...
*** Test Cases ***
################### Post ###################
CreateAThing_TST_F8_0_2_004_Error_ThingNameDuplicate
	...
	${ThingName_1st}=    Set Variable    ${postCreateAThing_1st}[4] 
	...
	#Body
    ${body}=    Evaluate    {"ConnectivityType": "${ConnectivityType_2nd}","ThingName" : "${ThingName_1st}","ThingIdentifier": "${ThingIdentifier_2nd}","ThingSecret": "${ThingSecret_2nd}","IMEI": "${IMEI_2nd}","CustomDetails":{},"SupplierDetail": {"SupplierId": "${SupplierId}","SupplierName": "${SupplierName}"}}
	...
	${bodyLog}=    Set Variable    {"ConnectivityType":"${ConnectivityType_2nd}","ThingName":"${ThingName_1st}","ThingIdentifier":"${ThingIdentifier_2nd}","ThingSecret":"${ThingSecret_2nd}","IMEI":"${IMEI_2nd}","CustomDetails":{},"SupplierDetail":{"SupplierId":"${SupplierId}","SupplierName":"${SupplierName}"}}
