...
*** Test Cases ***
################### Get ###################
ReturnsAListOfThings_TST_F9_1_1_002_Success_Top5
	...
	Run keyword And Continue On Failure    Should Be Equal As Strings    ${GetResponse_ThingInfo_Length}    5
	Run keyword And Continue On Failure    Should Be Equal As Strings    ${GetResponse_Metadata_Top}    5
