...
ReturnsAListOfThings_TST_F9_1_1_003_Success_Page2
	...
	Run keyword And Continue On Failure    Should Be Equal As Strings    ${GetResponse_ThingInfo_Length}    10
	Run keyword And Continue On Failure    Should Be Equal As Strings    ${GetResponse_Metadata_Top}    10
	Run keyword And Continue On Failure    Should Be Equal As Strings    ${GetResponse_Metadata_Page}    2
