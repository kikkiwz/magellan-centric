...
*** Test Cases ***
################### Post ###################
VerifiesThings_TST_F4_0_2_001_Error_ThingIdentifierNotFound
    ...
    ${expectResponse}=    Evaluate    [{"Status":"${VALUE_LOG_CODE_40400}","StatusDescription":"${VALUE_DESCRIPTION_NOTAVAILABLE_ERROR}"}]		
    ...
    ${responseLog}=    Set Variable    [{"ThingId":null,"ThingName":null,"ThingIdentifier":"${ThingIdentifier2}","ThingSecret":"${ThingSecret}","IMEI":"${IMEI}","Status":"${VALUE_LOG_CODE_40400}","StatusDescription":"${VALUE_DESCRIPTION_NOTAVAILABLE_ERROR}"}]
