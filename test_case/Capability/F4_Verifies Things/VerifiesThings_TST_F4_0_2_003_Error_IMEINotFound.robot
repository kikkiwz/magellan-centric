...
*** Test Cases ***
################### Post ###################
VerifiesThings_TST_F4_0_2_003_Error_IMEINotFound
    ...
    ${responseLog}=    Set Variable    [{"ThingId":null,"ThingName":null,"ThingIdentifier":"${ThingIdentifier}","ThingSecret":"${ThingSecret}","IMEI":"${IMEI2}","Status":"${VALUE_LOG_CODE_40400}","StatusDescription":"${VALUE_DESCRIPTION_NOTAVAILABLE_ERROR}"}]
