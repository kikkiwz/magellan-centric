...
*** Test Cases ***
################### Post ###################
VerifiesThings_TST_F4_0_3_001_Error_MissingWorkerId
    ...
    # ${replaceUrl}=    Replace String    ${URL_VERIFIESTHINGS}    [WorkerID]    ${EMPTY}
    # Log To Console    TESTURL : :${replaceUrl}

    #Response
    ${res}=    Run keyword And Continue On Failure    Post Api Request    ${URL_CENTRIC}${CENTRICAPIS}    ${URL_VERIFIESTHINGS_MISSINGWORKERID}    ${headers}    ${body}
    ...
    ${pathUrl}=    Set Variable    ${URL_VERIFIESTHINGS_MISSINGWORKERID}
