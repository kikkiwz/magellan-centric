...
*** Test Cases ***
################### Post ###################
VerifiesThings_TST_F4_0_4_001_Error_ThingIdentifierTest
	...
	#Body
    ${body}=    Evaluate    [{"ThingIdentifier":"Test","ThingSecret":"${ThingSecret}","IMEI":"${IMEI}"}]
    ...
    ${expectResponse}=    Evaluate    [{"Status":"${VALUE_LOG_CODE_40000}","StatusDescription":"${VALUE_DESCRIPTION_THINGIDENTIFIERTEST_ERROR}"}]		
	...
	${bodyLog}=    Set Variable    [{"ThingIdentifier":"Test","ThingSecret":"${ThingSecret}","IMEI":"${IMEI}"}]
    ${responseLog}=    Set Variable    [{"ThingId":null,"ThingName":null,"ThingIdentifier":"Test","ThingSecret":"${ThingSecret}","IMEI":"${IMEI}","Status":"${VALUE_LOG_CODE_40000}","StatusDescription":"${VALUE_DESCRIPTION_THINGIDENTIFIERTEST_ERROR}"}]
