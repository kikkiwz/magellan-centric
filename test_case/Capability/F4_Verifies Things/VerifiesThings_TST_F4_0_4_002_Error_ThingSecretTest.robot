...
*** Test Cases ***
################### Post ###################
VerifiesThings_TST_F4_0_4_002_Error_ThingSecretTest
	...
	#Body
    ${body}=    Evaluate    [{"ThingIdentifier":"${ThingIdentifier}","ThingSecret":"Test","IMEI":"${IMEI}"}]
	...
	${bodyLog}=    Set Variable    [{"ThingIdentifier":"${ThingIdentifier}","ThingSecret":"Test","IMEI":"${IMEI}"}]
    ${responseLog}=    Set Variable    [{"ThingId":null,"ThingName":null,"ThingIdentifier":"${ThingIdentifier}","ThingSecret":"Test","IMEI":"${IMEI}","Status":"${VALUE_LOG_CODE_40400}","StatusDescription":"${VALUE_DESCRIPTION_NOTAVAILABLE_ERROR}"}]
