...
*** Test Cases ***
################### Post ###################
VerifiesThings_TST_F4_0_4_003_Error_IMEITest
	...
	#Body
    ${body}=    Evaluate    [{"ThingIdentifier":"${ThingIdentifier}","ThingSecret":"${ThingSecret}","IMEI":"Test"}]
    ...
    ${expectResponse}=    Evaluate    [{"Status":"${VALUE_LOG_CODE_40000}","StatusDescription":"${VALUE_DESCRIPTION_IMEITEST_ERROR}"}]		
    ...
    # ${endPointName}=    Set Variable    ["db.ThingsCollection","db.WorkersCollection"]
	...
	${bodyLog}=    Set Variable    [{"ThingIdentifier":"${ThingIdentifier}","ThingSecret":"${ThingSecret}","IMEI":"Test"}]
    ${responseLog}=    Set Variable    [{"ThingId":null,"ThingName":null,"ThingIdentifier":"${ThingIdentifier}","ThingSecret":"${ThingSecret}","IMEI":"Test","Status":"${VALUE_LOG_CODE_40000}","StatusDescription":"${VALUE_DESCRIPTION_IMEITEST_ERROR}"}]
