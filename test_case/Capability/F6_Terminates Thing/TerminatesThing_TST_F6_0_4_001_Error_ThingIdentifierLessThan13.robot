...
*** Test Cases ***
################### Post ###################
TerminatesThing_TST_F6_0_4_001_Error_ThingIdentifierLessThan13
    ...
    ${responseLog}=    Set Variable    [{"ThingIdentifier":"${ThingIdentifier2}","ThingSecret":"${ThingSecret}","IMEI":"${IMEI}","Status":"${VALUE_LOG_CODE_40000}","StatusDescription":"${VALUE_DESCRIPTION_THINGIDENTIFIERLESSTHAN13_ERROR}"}]		
