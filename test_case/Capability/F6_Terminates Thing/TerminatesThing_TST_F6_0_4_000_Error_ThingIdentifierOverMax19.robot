...
*** Test Cases ***
################### Post ###################
TerminatesThing_TST_F6_0_4_000_Error_ThingIdentifierOverMax19
	...
	#Body
    ${body}=    Evaluate    [{"ThingIdentifier":"${ThingIdentifier2}","ThingSecret":"${ThingSecret}","IMEI":"${IMEI}"}]
    ...
    ${bodyLog}=    Set Variable    [{"ThingIdentifier":"${ThingIdentifier2}","ThingSecret":"${ThingSecret}","IMEI":"${IMEI}"}]		
    ${responseLog}=    Set Variable    [{"ThingIdentifier":"${ThingIdentifier2}","ThingSecret":"${ThingSecret}","IMEI":"${IMEI}","Status":"${VALUE_LOG_CODE_40000}","StatusDescription":"${VALUE_DESCRIPTION_THINGIDENTIFIEROVERMAX19_ERROR}"}]		
