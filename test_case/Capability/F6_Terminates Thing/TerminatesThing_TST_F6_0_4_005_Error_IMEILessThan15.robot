...
*** Test Cases ***
################### Post ###################
TerminatesThing_TST_F6_0_4_005_Error_IMEILessThan15
    ...
    ${responseLog}=    Set Variable    [{"ThingIdentifier":"${ThingIdentifier}","ThingSecret":"${ThingSecret}","IMEI":"${IMEI2}","Status":"${VALUE_LOG_CODE_40000}","StatusDescription":"${VALUE_DESCRIPTION_IMEILESSTHAN15_ERROR}"}]		
