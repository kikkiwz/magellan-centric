...
*** Test Cases ***
################### Post ###################
ActivateThings_TST_F5_0_2_004_Error_ThingSecretNotFound
...
#-------- Prepare data 1 --------
	...
	#Body
    ${body}=    Evaluate    [{"ThingSecret":"${ThingSecret2}"}]
	...
	${bodyLog}=    Set Variable    [{"ThingSecret":"${ThingSecret2}"}]
    ${responseLog}=    Set Variable    [{"ThingId":null,"ThingName":null,"ThingIdentifier":null,"ThingSecret":"${ThingSecret2}","IMEI":null,"ThingDescription":null,"SupplierDetail":null,"Status":"${VALUE_LOG_CODE_40400}","StatusDescription":"${VALUE_DESCRIPTION_THINGCOULDNOTFOUND_ERROR}"}]
