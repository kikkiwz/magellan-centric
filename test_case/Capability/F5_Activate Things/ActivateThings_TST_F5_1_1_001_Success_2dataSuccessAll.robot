...
*** Test Cases ***
################### Post ###################
ActivateThings_TST_F5_1_1_001_Success_2dataSuccessAll
	...
	#Body
    ${body}=    Evaluate    [{"ThingIdentifier":"${ThingIdentifier}"},{"ThingSecret":"${ThingSecret2}"}]
    ...
    ${checkReponse}=    Run keyword And Continue On Failure    Response Status And StatusDespcription Should Have    ${res}    ${ACTIVATETHINGS}
    ...
    # ${endPointName}=    Set Variable    ["db.ThingsCollection","db.ThingsCollection","db.ThingsCollection","db.WorkersCollection","db.ThingsCollection"]
    # ${custom}=    Set Variable    { "endPointSummary":[ { "no":"1", "endPointName":"db.WorkersCollection", "endPointURL":null, "responseStatus":"20000:InquiryWorkers was Success", "processTime":null }, { "no":"2", "endPointName":"db.ThingsCollection", "endPointURL":null, "responseStatus":"20000:InquiryThing was Success", "processTime":null }, { "no":"3", "endPointName":"db.ThingsCollection", "endPointURL":null, "responseStatus":"20000:UpdateThing was Success", "processTime":null }, { "no":"4", "endPointName":"db.ThingsCollection", "endPointURL":null, "responseStatus":"20000:InquiryThing was Success", "processTime":null }, { "no":"5", "endPointName":"db.ThingsCollection", "endPointURL":null, "responseStatus":"20000:UpdateThing was Success", "processTime":null }]}     	 
	# ${customDetailDB}=    Set Variable    { "endPointSummary":[ { "no":"1", "endPointName":"db.WorkersCollection", "endPointURL":null, "responseStatus":"20000:InquiryWorkers was Success", "processTime":null }, { "no":"2", "endPointName":"db.ThingsCollection", "endPointURL":null, "responseStatus":"20000:InquiryThing was Success", "processTime":null }, { "no":"3", "endPointName":"db.ThingsCollection", "endPointURL":null, "responseStatus":"20000:UpdateThing was Success", "processTime":null }, { "no":"4", "endPointName":"db.ThingsCollection", "endPointURL":null, "responseStatus":"20000:InquiryThing was Success", "processTime":null }, { "no":"5", "endPointName":"db.ThingsCollection", "endPointURL":null, "responseStatus":"20000:UpdateThing was Success", "processTime":null }]}
    ${responseObjectDetail}=    Set Variable    null       

    ${bodyLog}=    Set Variable    [{"ThingIdentifier":"${ThingIdentifier}"},{"ThingSecret":"${ThingSecret2}"}]		
    ${responseLog}=    Set Variable    [{"ThingId":"${ThingId}","ThingName":"${ThingName}","ThingIdentifier":"${ThingIdentifier}","ThingSecret":"${ThingSecret}","IMEI":"${IMEI}","ThingDescription":null,"SupplierDetail":{"SupplierId":"${SupplierId}","SupplierName":"${SupplierName}"},"Status":"${VALUE_LOG_CODE_20000}","StatusDescription":"${VALUE_DESCRIPTION_ACTIVATETHINGS_SUCCESS}"},{"ThingId":"${ThingId2}","ThingName":"${ThingName2}","ThingIdentifier":"${ThingIdentifier2}","ThingSecret":"${ThingSecret2}","IMEI":"${IMEI2}","ThingDescription":null,"SupplierDetail":{"SupplierId":"${SupplierId2}","SupplierName":"${SupplierName2}"},"Status":"${VALUE_LOG_CODE_20000}","StatusDescription":"${VALUE_DESCRIPTION_ACTIVATETHINGS_SUCCESS}"}]		
    ...
    Sleep    2s
    Run Keyword If    "${checkReponse}"=="true"    Request Verify DB Check Data ActivateThings    ${ThingId2}    ${WorkerId}    ${ConnectivityType2}    ${ThingName2}    ${ThingIdentifier2}    ${ThingSecret2}    ${IMEI2}    ${SupplierId2}    ${SupplierName2}            
    
    [Teardown]    Generic Test Case Teardown    ${ACTIVATETHINGS2DATA}    ${createResponse}    null