...
*** Test Cases ***
################### Post ###################
ActivateThings_TST_F5_0_2_001_Error_ThingStateActivated
	...
	${createResponse}=    Request CreateData for CreateAWorker And CreateAThing No Have WorkerId And ActivateThings    ${ConnectivityType1}    ${ThingState1}    ${ThingIdentifier1}    ${ThingSecret1}    ${IMEI1}              
    ...
    ${responseLog}=    Set Variable    [{"ThingId":null,"ThingName":null,"ThingIdentifier":"${ThingIdentifier1}","ThingSecret":"${ThingSecret1}","IMEI":"${IMEI1}","ThingDescription":null,"SupplierDetail":{"SupplierId":"${SupplierId}","SupplierName":"${SupplierName}"},"Status":"${VALUE_LOG_CODE_40301}","StatusDescription":"${VALUE_DESCRIPTION_THECLIENTREQUESTEDALREADYEXISTS_ERROR}"}]
