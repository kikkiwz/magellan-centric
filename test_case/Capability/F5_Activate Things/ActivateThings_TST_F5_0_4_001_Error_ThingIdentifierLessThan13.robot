...
*** Test Cases ***
################### Post ###################
ActivateThings_TST_F5_0_4_001_Error_ThingIdentifierLessThan13
	...
	${randomICCID4}=    Evaluate    random.randint(10000, 99999)    random
    ...
    ${expectResponse}=    Evaluate    [{"Status":"${VALUE_LOG_CODE_40000}","StatusDescription":"${VALUE_DESCRIPTION_THINGIDENTIFIERLESSTHAN13_ERROR}"}]		
    ...
    ${responseLog}=    Set Variable    [{"ThingId":null,"ThingName":null,"ThingIdentifier":"${ThingIdentifier2}","ThingSecret":"${ThingSecret1}","IMEI":"${IMEI1}","ThingDescription":null,"SupplierDetail":null,"Status":"${VALUE_LOG_CODE_40000}","StatusDescription":"${VALUE_DESCRIPTION_THINGIDENTIFIERLESSTHAN13_ERROR}"}]
