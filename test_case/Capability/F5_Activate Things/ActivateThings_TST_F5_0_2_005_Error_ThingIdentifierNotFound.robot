...
*** Test Cases ***
################### Post ###################
ActivateThings_TST_F5_0_2_005_Error_ThingIdentifierNotFound
	...
	#Body
    ${body}=    Evaluate    [{"ThingIdentifier":"${ThingIdentifier2}"}]
	...
	${bodyLog}=    Set Variable    [{"ThingIdentifier":"${ThingIdentifier2}"}]
    ${responseLog}=    Set Variable    [{"ThingId":null,"ThingName":null,"ThingIdentifier":"${ThingIdentifier2Response}","ThingSecret":null,"IMEI":null,"ThingDescription":null,"SupplierDetail":null,"Status":"${VALUE_LOG_CODE_40400}","StatusDescription":"${VALUE_DESCRIPTION_THINGCOULDNOTFOUND_ERROR}"}]
