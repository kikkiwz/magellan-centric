...
*** Test Cases ***
################### Post ###################
ActivateThings_TST_F5_0_2_006_Error_ThingStateIdleBodyHaveNotData 
    ...
    ${ThingState1}=    Set Variable    ${VALUE_THINGSTATE_IDLE}
    ${ThingState2}=    Set Variable    ${VALUE_THINGSTATE_IDLE}
    ...
    ${responseLog}=    Set Variable    [{"ThingId":null,"ThingName":null,"ThingIdentifier":null,"ThingSecret":null,"IMEI":null,"ThingDescription":null,"SupplierDetail":null,"Status":"${VALUE_LOG_CODE_40000}","StatusDescription":"${VALUE_DESCRIPTION_THECLIENTREQUESTEDMISSINGORINVALIDFORMAT_ERROR}"}]
