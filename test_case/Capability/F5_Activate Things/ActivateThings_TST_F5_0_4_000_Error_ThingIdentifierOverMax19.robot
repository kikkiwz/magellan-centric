...
*** Test Cases ***
################### Post ###################
ActivateThings_TST_F5_0_4_000_Error_ThingIdentifierOverMax19
    ...
    ${randomICCID5}=    Evaluate    random.randint(100000, 999999)    random
	${ThingIdentifier2}=    Set Variable    ${FIELD_ICCIDPRE}${randomICCID3}${randomICCID4}${randomICCID5}
	...
	#Body
    ${body}=    Evaluate    [{"ThingIdentifier":"${ThingIdentifier2}","ThingSecret":"${ThingSecret1}","IMEI":"${IMEI1}"}]
    ...
    ${expectResponse}=    Evaluate    [{"Status":"${VALUE_LOG_CODE_40000}","StatusDescription":"${VALUE_DESCRIPTION_THINGIDENTIFIEROVERMAX19_ERROR}"}]		
	...
	${bodyLog}=    Set Variable    [{"ThingIdentifier":"${ThingIdentifier2}","ThingSecret":"${ThingSecret1}","IMEI":"${IMEI1}"}]
    ${responseLog}=    Set Variable    [{"ThingId":null,"ThingName":null,"ThingIdentifier":"${ThingIdentifier2}","ThingSecret":"${ThingSecret1}","IMEI":"${IMEI1}","ThingDescription":null,"SupplierDetail":null,"Status":"${VALUE_LOG_CODE_40000}","StatusDescription":"${VALUE_DESCRIPTION_THINGIDENTIFIEROVERMAX19_ERROR}"}]
