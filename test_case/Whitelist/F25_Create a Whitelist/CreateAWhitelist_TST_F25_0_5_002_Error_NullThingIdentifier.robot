...
*** Test Cases ***
################### Post ###################
CreateAWhitelist_TST_F25_0_5_002_Error_NullThingIdentifier
	...
	#Body
    ${body}=    Evaluate    [{"OwnerType":"${OwnerType_Account}","OwnerId":"${CustomerId}","ThingIdentifier":[]}]
    ...
    ${bodyChecklog}=    Set Variable    [{"OwnerType":"${OwnerType_Account}","OwnerId":"${CustomerId}","ThingIdentifier":[]}] 
