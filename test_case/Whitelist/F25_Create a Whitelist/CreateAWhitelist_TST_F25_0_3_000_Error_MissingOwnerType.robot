...
*** Test Cases ***
################### Post ###################
CreateAWhitelist_TST_F25_0_3_000_Error_MissingOwnerType
	...
	#Body
    ${body}=    Evaluate    [{"OwnerId":"${CustomerId}","ThingIdentifier":["${ThingIdentifier}"]}]
    ...
    ${bodyChecklog}=    Set Variable    [{"OwnerId":"${CustomerId}","ThingIdentifier":["${ThingIdentifier}"]}] 
