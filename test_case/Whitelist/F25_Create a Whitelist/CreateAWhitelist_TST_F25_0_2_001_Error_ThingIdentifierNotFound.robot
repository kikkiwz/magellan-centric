...
*** Test Cases ***
################### Post ###################
CreateAWhitelist_TST_F25_0_2_001_Error_ThingIdentifierNotFound
    ...
    ${ThingIdentifier_NotFound}=    Set Variable    89660316491567699078
	...
	#Body
    ${body}=    Evaluate    [{"OwnerType":"${OwnerType_Customer}","OwnerId":"${CustomerId}","ThingIdentifier":["${ThingIdentifier_NotFound}"]}]
    ...
    # ${responseObjectDetail}=    Set Variable    null
    ${bodyChecklog}=    Set Variable    [{"OwnerType":"${OwnerType_Customer}","OwnerId":"${CustomerId}","ThingIdentifier":["${ThingIdentifier_NotFound}"]}] 
