...
*** Test Cases ***
################### Post ###################
CreateAWhitelist_TST_F25_0_4_001_Error_ThingIdentifierLessThan19
	...
	#Body
    ${body}=    Evaluate    [{"OwnerType":"${OwnerType_Tenant}","OwnerId":"${CustomerId}","ThingIdentifier":["12345"]}]
    ...
    # ${responseObjectDetail}=    Set Variable    null
    ${bodyChecklog}=    Set Variable    [{"OwnerType":"${OwnerType_Tenant}","OwnerId":"${CustomerId}","ThingIdentifier":["12345"]}] 
