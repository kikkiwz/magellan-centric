...
*** Test Cases ***
################### Post ###################
CreateAWhitelist_TST_F25_1_1_000_Success_OwnerTypeIsCustomer
	...
	#Body
    ${body}=    Evaluate    [{"OwnerType":"${OwnerType_Customer}","OwnerId":"${CustomerId}","ThingIdentifier":["${ThingIdentifier}"]}]
    ...
    Log CreateAWhitelist Success    ${res}    ${pathUrl}    ${dataSearch}    ${CustomerId}    ${OwnerType_Customer}    ${ThingIdentifier}         

    #Inquiry for verify DB   
    Run Keyword If    "${checkReponse}"=="true"    Request Verify DB Check Data Whitelist    ${body}    ${OwnerType_Customer}    ${CustomerId}    ${AccountId}    ${ThingIdentifier}            
