...
*** Test Cases ***
################### Post ###################
CreateAWhitelist_TST_F25_0_3_002_Error_MissingThingIdentifier
	...
	#Body
    ${body}=    Evaluate    [{"OwnerType":"${OwnerType_Tenant}","OwnerId":"${CustomerId}"}]
    ...
    ${bodyChecklog}=    Set Variable    [{"OwnerType":"${OwnerType_Tenant}","OwnerId":"${CustomerId}"}] 
