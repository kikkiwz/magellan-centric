...
*** Test Cases ***
################### Post ###################
CreateAWhitelist_TST_F25_0_5_001_Error_NullOwnerId
	...
	#Body
    ${body}=    Evaluate    [{"OwnerType":"${OwnerType_Account}","OwnerId":"","ThingIdentifier":["${ThingIdentifier}"]}]
    ...
    ${bodyChecklog}=    Set Variable    [{"OwnerType":"${OwnerType_Account}","OwnerId":"","ThingIdentifier":["${ThingIdentifier}"]}] 
