...
*** Test Cases ***
################### Post ###################
CreateAWhitelist_TST_F25_1_1_002_Success_OwnerTypeIsAccount
	...
	#Body
    ${body}=    Evaluate    [{"OwnerType":"${OwnerType_Account}","OwnerId":"${AccountId}","ThingIdentifier":["${ThingIdentifier}"]}]
    ...
    Log CreateAWhitelist Success    ${res}    ${pathUrl}    ${dataSearch}    ${AccountId}    ${OwnerType_Account}    ${ThingIdentifier}         

    #Inquiry for verify DB   
    Run Keyword If    "${checkReponse}"=="true"    Request Verify DB Check Data Whitelist    ${body}    ${OwnerType_Account}    ${AccountId}    ${AccountId}    ${ThingIdentifier}            
