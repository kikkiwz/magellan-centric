...
*** Test Cases ***
################### Post ###################
UpdateAWhitelist_TST_F26_0_2_000_Error_ThingIdentifierNotFound
	...
	#Body
    ${body}=    Evaluate    {"ThingIdentifier":["${ThingIdentifier_NotFound}"]}
    ...
    ${responseObjectDetail}=    Set Variable    [{"Target":"ThingIdentifier","DeveloperMessage":"The ThingIdentifier '${ThingIdentifier_NotFound}' could not be found."}]
    ...
    # ${responseObjectDetail}=    Set Variable    [{"Target":"ThingIdentifier","DeveloperMessage":"The ThingIdentifier '${ThingIdentifier_NotFound}' could not be found."}]
    ${bodyChecklog}=    Set Variable    {"ThingIdentifier":["${ThingIdentifier_NotFound}"]} 
