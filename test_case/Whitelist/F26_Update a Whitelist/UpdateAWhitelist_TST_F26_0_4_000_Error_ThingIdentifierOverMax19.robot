...
*** Test Cases ***
################### Post ###################
UpdateAWhitelist_TST_F26_0_4_000_Error_ThingIdentifierOverMax19
	...
	#Body
    ${body}=    Evaluate    {"ThingIdentifier":["${ThingIdentifier}123456"]}
    Log To Console    Body is : ${body}


    #Replace Customerid in Url
    ${replace_Url_UpdateWhitelist}=    Replace String    ${URL_UPDATEAWHITELIST}    [OwnersId]    ${CustomerId}
    ...
    ${responseObjectDetail}=    Set Variable    [{"Target":"ThingIdentifier","DeveloperMessage":"The ThingIdentifier '${ThingIdentifier}123456' could not be found."}]
    ...
    # ${responseObjectDetail}=    Set Variable    [{"Target":"ThingIdentifier","DeveloperMessage":"The ThingIdentifier '${ThingIdentifier}123456' could not be found."}]
    ${bodyChecklog}=    Set Variable    {"ThingIdentifier":["${ThingIdentifier}123456"]} 
    ...
    Log UpdateAWhitelist Error    ${VALUE_LOG_CODE_40400}    ${VALUE_DESCRIPTION_THEREQUESTEDOPERATIONCOULDNOTBEFOUND_ERROR}    ${VALUE_LOG_CODE_40400}    ${VALUE_DESCRIPTION_THEREQUESTEDOPERATIONCOULDNOTBEFOUND_ERROR}    ${res}    ${pathUrl}    ${dataSearch}    ${AccountId}    ${endPointName}    ${custom}    ${customDetailDB}    ${responseObjectDetail}    ${bodyChecklog}
