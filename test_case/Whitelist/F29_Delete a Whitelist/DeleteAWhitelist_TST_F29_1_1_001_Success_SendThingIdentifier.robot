...
*** Test Cases ***
################### Post ###################
DeleteAWhitelist_TST_F29_1_1_001_Success_SendThingIdentifier
    ...
    Log DeleteAWhitelist Success    ${res}    ${pathUrl}    ${dataSearch}    ${AccountId}    ${ThingIdentifier}    ${bodyCheckLog}    
